export const services = [
  ...
  },
  {
    ...
    subtitle: 'Starting From Rs. 70,000',
  ...
  },
  {
    ...
    subtitle: 'Starting From Rs. 140,000',
  ...
  {
    title: 'PK Domains Management & Hosting (Static)',
    subtitle: 'Starting from Rs. 10,000/year',
    description: 'Domain management & hosting becomes quite tough for regular persons to handle. Save yourself from hassle of domain management & hosting. Leave all on us.',
  },
  {
    title: 'PK Domains Management & Hosting, Small-Scale (Dynamic)',
    subtitle: 'Starting from Rs. 15,000/year',
    description: 'Domain management & hosting becomes quite tough for regular persons to handle. Save yourself from hassle of domain management & hosting. Leave all on us.',
  },
  {
    title: 'PK Domains Management & Hosting, Medium-Scale (Dynamic)',
    subtitle: 'Starting from Rs. 20,000/year',
    description: 'Domain management & hosting becomes quite tough for regular persons to handle. Save yourself from hassle of domain management & hosting. Leave all on us.',
  },
  {
    title: 'PK Domains Management & Hosting, Large-Scale (Dynamic)',
    subtitle: 'Contact For Pricing',
    description: 'Domain management & hosting becomes quite tough for regular persons to handle. Save yourself from hassle of domain management & hosting. Leave all on us.',
  },
  // {
  //   title: 'Convert Design Files To Websites',
  //   subtitle: 'Starting From Rs. $29.99',
